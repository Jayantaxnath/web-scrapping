...
MAX_PAGES_TO_SCRAPE = 1  # Change this to 5, 10, 20, etc. as needed


try:
    # Use the updated URL for work-from-home internships
    ...
    print(f"Starting to scrape {total_no_pages} pages...")
